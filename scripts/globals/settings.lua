...
START_GIL = 500000; -- Amount of gil given to newly created characters.
...
EXP_RATE        = 25.000; -- Multiplies exp earned from fov and quests.
TABS_RATE       = 10.000; -- Multiplies tabs earned from fov.
...
HARVESTING_BREAK_CHANCE = 0.00; -- % chance for the sickle to break during harvesting.  Set between 0 and 1.
EXCAVATION_BREAK_CHANCE = 0.00; -- % chance for the pickaxe to break during excavation.  Set between 0 and 1.
LOGGING_BREAK_CHANCE    = 0.00; -- % chance for the hatchet to break during logging.  Set between 0 and 1.
MINING_BREAK_CHANCE     = 0.00; -- % chance for the pickaxe to break during mining.  Set between 0 and 1.
...
COFFER_MAX_ILLUSION_TIME = 180;  -- 3 minutes
COFFER_MIN_ILLUSION_TIME = 60;  -- 1 minute
CHEST_MAX_ILLUSION_TIME  = 180;  -- 3 minutes
...
-- DYNAMIS SETTINGS
    ...
    TIMELESS_HOURGLASS_COST = 1000;   -- cost of the timeless hourglass for Dynamis.
     CURRENCY_EXCHANGE_RATE = 20;      -- X Tier 1 ancient currency -> 1 Tier 2, and so on.  Certain values may conflict with shop items.  Not designed to exceed 198.
RELIC_2ND_UPGRADE_WAIT_TIME = 10;      -- wait time for 2nd relic upgrade (stage 2 -> stage 3) in seconds. 604800s = 1 RL week.
RELIC_3RD_UPGRADE_WAIT_TIME = 10;      -- wait time for 3rd relic upgrade (stage 3 -> stage 4) in seconds. 295200s = 82 hours.
...
SNEAK_INVIS_DURATION_MULTIPLIER = 20; -- multiplies duration of sneak,invis,deodorize to reduce player torture. 1 = retail behavior.
...
JINX_MODE_2005 = 1; -- Set to 1 to give starting characters swimsuits from 2005.  Ex: Hume Top
JINX_MODE_2008 = 1; -- Set to 1 to give starting characters swimsuits from 2008.  Ex: Custom Top
JINX_MODE_2012 = 1; -- Set to 1 to give starting characters swimsuits from 2012.  Ex: Marine Top
SUMMERFEST_2004 = 1; -- Set to 1 to give starting characters Far East dress from 2004.  Ex: Onoko Yukata
SUNBREEZE_2009 = 1; -- Set to 1 to give starting characters Far East dress from 2009.  Ex: Otokogusa Yukata
SUNBREEZE_2011 = 1; -- Set to 1 to give starting characters Far East dress from 2011.  Ex: Hikogami Yukata
...
-- ABYSSEA
VISITANT_BONUS = 10.00; -- Default: 1.00 - (retail) - Multiplies the base time value of each Traverser Stone.